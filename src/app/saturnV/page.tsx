      ...
      <div className="max-w-[75%] mx-auto pt-8">
        <div ref={introRef} className="mb-12">
          ...
          <div className="space-y-4 text-base leading-relaxed mb-8">
            <p>
              A dynamic, animated, central hub for information about the Saturn V rocket and its
              history.
            </p>
            <p>
              This project was built using WordPress with custom CSS animations and After Effects
              integration to create an immersive experience about the Apollo program.
            </p>
          </div>
