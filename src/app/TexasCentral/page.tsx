...
const otherProjects = [
  {
    ...
    description:
      'a rebrand for a record label created to provide a platform for incarcerated and formerly incarcerated prisoners.',
    link: '/DieJimCrow',
    id: '1',
  },
  {
      ...
      <div className="max-w-[75%] mx-auto pt-8">
        <div ref={introRef} className="mb-12">
          ...
          <div className="space-y-4 text-base leading-relaxed mb-8">
            <p>
              Prospective branding for Texas Central, a proposed high speed rail system connecting
              DFW, Austin, and Houston.
            </p>
            <p>
              This project focused on creating a modern, forward-thinking identity that would
              represent the future of transportation in Texas while honoring the state&apos;s
              heritage and connecting its major metropolitan areas.
            </p>
          </div>
        </div>
        ...
        <div className="mb-12">
          <h2 className="text-xl font-bold mb-8 title">Check out my other design projects:</h2>
