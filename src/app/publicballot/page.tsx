      ...
      <div className="max-w-[75%] mx-auto pt-8">
        <div ref={introRef} className="mb-12">
          ...
          <div className="space-y-4 text-base leading-relaxed mb-8">
            <p>
              A friend and I made public ballot in our spare time to try and bring attention to
              local elections during the 2020 election cycle.
            </p>
            <p>
              The site is live and still serving data from the 2020 election, you can check it out
              for yourself{' '}
              <a
          ...
          <div className="grid md:grid-cols-2 gap-5 mb-12">
            ...
            <div className="border-2 rounded-2xl border-black bg-white p-5">
              ...
              <p className="mb-4">
                I was the lead front-end developer on this project, focused on designing and
                implementing the user interface, as well as directing the overall structure of the
                project and the data we are sorting and displaying.
              </p>
        ...
        <div className="mb-12">
          <h2 className="text-xl font-bold mb-8 title">
            This started out as my class project, originally called ourvote. Here&apos;s a deck
            outlining the app&apos;s entire proposed functionality.
          </h2>
        ...
        <div className="mb-12">
          <h2 className="text-xl font-bold mb-8 title">
            I&apos;m very proud that this project became a real usable product! I really do love
            this one. Check out my other two projects on display, I think they&apos;re just as cool:
          </h2>
