      ...
      <div className="max-w-[75%] mx-auto pt-8">
        <div ref={introRef} className="mb-12">
          ...
          <div className="space-y-4 text-base leading-relaxed mb-8">
            <p>
              A new identity system for Dynasty, a manufacturer of percussion instruments for the
              top competitive drum ensembles across the world.
            </p>
            <p>
              This rebrand focused on creating a bold, modern identity that reflects the precision
              and excellence of Dynasty&apos;s instruments while appealing to the competitive
