      ...
      <div className="max-w-[75%] mx-auto pt-8">
        <div ref={introRef} className="mb-12">
          ...
          <div className="space-y-4 text-base leading-relaxed mb-8">
            <p>
              I created this rebrand for Die Jim Crow, a record label for currently and formerly
              incarcerated prisoners. I wanted to create a brand that connected the real life fight
              for justice to a culture of artistry and activism.
            </p>
          </div>
        </div>
